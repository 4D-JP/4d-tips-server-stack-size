...
[サーバー上で実行](http://doc.4d.com/4Dv16/4D/16/Execute-on-Server-attribute.300-3047542.ja.html)メソッドプロパティをうまく活用すれば，ネットワークトラフィックの**回数**や転送データの**サイズ**を劇的に最適化できることがあるのは確かです。しかし，純粋なクエリについていえば，データベースアクセス専門の「相方」プロセスとの通信，つまり，クライアント側でクエリしたほうがスケーラブルである，ということができます。
